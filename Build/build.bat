...
set project= "C:\Home\Cowrie\selectedhot.local\DesktopModules\ClothDetails"
set rootPath="C:\Home\Cowrie\selectedhot.local\Bin"
set package= "C:\Temp\ClothDetails"
...
cd %package%
"C:\Program Files\7-Zip\7z" a -tzip ClothDetails.zip *.*
